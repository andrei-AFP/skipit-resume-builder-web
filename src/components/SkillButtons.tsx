  ...
  return (
    <>
      {props.skills?.map((skill) => (
        <div
          key={skill.id}
          className={`${colorMap[skill.skill_type.color as string]} group relative inline-flex items-center overflow-hidden rounded-full px-4 py-2 transition cursor-pointer`}
        >
