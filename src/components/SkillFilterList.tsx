...
const SkillFilterList = observer(({ showFilteredSkills }: ISkillFilterListProps) => {
  ...
  return (
    <>
      <div className="fixed bottom-0 w-full py-4 bg-[#1a1a1a] z-20 flex overflow-x-auto no-scrollbar shadow-[0px_0px_20px_0px_rgba(0,_0,_0,_0.5)] lg:relative lg:justify-end lg:py-0 lg:shadow-none">
        <DraggableScroll>
